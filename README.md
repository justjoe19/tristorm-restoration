...
*   **Responsive Design:** Optimized for seamless viewing across various devices (desktop, tablet, mobile) using Bootstrap 5.
*   **Comprehensive Service Showcase:** Detailed sections for each restoration service offered.
*   **Team Introduction:** "Meet Our Team" section with individual bios for key personnel.
*   **Customer Testimonials:** A dynamic carousel displaying positive client reviews.
...
*   **CSS3:** For custom styling and theme application.
...
This is a static website, so no specific server-side setup is required beyond a web server to serve the files.

1.  **Clone the repository:**
    ```bash
    git clone [repository-url]
    cd tristorm-restoration
    ```
2.  **Open `index.html`:**
    Simply open the `index.html` file in your preferred web browser to view the site locally. For development, you might use a local development server (e.g., Live Server VS Code extension) to ensure all paths and scripts load correctly.
...
├── images/                # WebP optimized images for services, team, and branding
├── js/
│   ├── bootstrap.bundle.min.js
│   └── script.js          # Custom JavaScript for smooth scrolling and interactivity
├── .gitignore             # Specifies intentionally untracked files to ignore
├── index.html             # The main landing page of the website
├── robots.txt             # Directives for web crawlers
├── sitemap.xml            # XML sitemap for search engines
├── ... (other favicon, manifest files)
```

## License

This project is proprietary and all rights are reserved by TriStorm Restoration.
